...
export class StarshipSingleV1Models {
    /**
     *
     ...
     * @param { Array<LinkModels> } films - An array of Film URL Resources that this starship has appeared in.
     * @param { Array<LinkModels> } pilots - An array of People URL Resources that this starship has been piloted by.
    ...
    constructor(
        ...
        public pilots: Array<LinkModels>,
        public url: string,
